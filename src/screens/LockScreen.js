    ...
    <>
      ...
      {PINInputScreen && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="absolute bottom-0 left-0 right-0 top-0 h-screen w-screen text-white backdrop-blur-xl"
        >
          <div className="mt-28 flex flex-col items-center justify-center">
            ...
            {loginIsSuccess ? (
              <div className="mt-3 flex flex-col items-center justify-center">
                <div className="my-3 h-16 w-16 animate-spin rounded-full border-r-4 border-t-4 border-dotted border-white bg-transparent"></div>
                ...
                {PINAttemptIsWrong ? (
                  ...
                  <>
                    <div className="mt-7 rounded-sm bg-gray-800 bg-opacity-70 backdrop-blur-xl">
                      ...
                      />
                      <div className="absolute right-[2px] top-[2.5px] p-1">
      ...
      {helpForgotPIN && (
        ...
        >
          <NotificationFrom
            from="Hyunwoo Kim (김현우)"
            image={profiles.hyunwoo}
            message={
              <>
                안녕하세요, 김현우 개발자입니다!
                <br /> 비밀번호는{" "}
                <span className="font-semibold">{validPIN}</span> 입니다.
              </>
            }
          />
        </motion.div>
