          ...
          <div className="relative">
            ...
            {featuresToggled && (
              <motion.div
                initial={{ right: -1000 }}
                animate={{ right: -77 }}
                className="absolute -right-[77px] -top-[281px] z-10 rounded-md border-[1px] text-sm leading-normal text-gray-100 shadow-lg backdrop-blur-xl backdrop-filter"
              >
                <div className="h-70 w-80 p-4">
                  <div className="mb-4 grid w-full grid-flow-row grid-cols-3 gap-4 text-center text-xs">
                    <div>
                      ...
                      <p className="mt-1">Hyunwoo Kim</p>
                    </div>
                    <div>
                      <div className="grid place-content-center rounded-md border-[1px] border-gray-300 bg-transparent p-4 shadow-lg backdrop-blur-2xl backdrop-filter hover:bg-white/10">
                        <BiBluetooth size={19} />
          ...
          <div className="relative">
            ...
            {dateToggled && (
              <motion.div
                initial={{ right: -1000 }}
                animate={{ right: 0 }}
                className="inverse-toggle absolute -right-0 -top-[50px] z-10 rounded-md  border-[1px] border-gray-300 bg-transparent text-sm leading-normal text-gray-100 subpixel-antialiased shadow-lg backdrop-blur-2xl backdrop-filter"
              >
