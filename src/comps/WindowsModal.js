...
const WindowsModal = () => {
  ...
  return (
    <motion.div
      ...
      } top-[2vh] h-[87vh] w-full rounded-md border-[1px] border-gray-500 bg-transparent text-white subpixel-antialiased backdrop-blur-2xl backdrop-filter lg:left-[30vw] lg:top-[5vh] lg:h-[87vh] lg:w-[40vw]`}
    >
      <div className="bg-red-5000 h-[77vh] overflow-hidden px-4 py-2">
        <input
          type="search"
          className="my-4 h-8 w-full rounded-sm border-b-2 border-l-0 border-r-0 border-t-0 border-b-white bg-transparent placeholder:text-white focus:outline-none"
